...
{
    public Result<List<Spammer>> PullSpammers(UserCredentials user, Context context) 
    {
        Result<List<Spammer>> result = new Result<List<Spammer>>();
        ...
        try 
        {
			...
			{
				result.setValue(new DynamoDBMapper(dynamoDBClient).scan(Spammer.class, new DynamoDBScanExpression()));
